            ...
            <div class="row">
             ...
             <div class="col-sm-12">
                ...
                <table class="display" id="basic-1">
                        ...
                        <tbody>
                           <?php 
										$city = $service->query("select * from tbl_timeslot where vendor_id=".$sdata['id']." order by id desc");
										$i=0;
										while($row = $city->fetch_assoc())
										{
											...
											<tr>
												...
												<td> <?php $gcat = $service->query("select * from tbl_category where id=".$row['cat_id']."")->fetch_assoc(); echo $gcat['title']; ?></td>
												
												
                                               
                                                <?php if($row['day_type'] == 0) { ?>
												
                                                <td><span class="badge badge-success">Current</span></td>
												<?php } else { ?>
												
												<td>
												<span class="badge badge-danger">Next</span></td>
												<?php } ?>
                                           ...
                                           <div class="btn-group btn-group-sm" style="float: none;">
										    ...
										    <a href="add_Timeslot.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;">
