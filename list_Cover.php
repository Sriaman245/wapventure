             ...
             <div class="col-sm-12">
				...
				if(isset($_GET['list_image_id']))
				{
					...
					<table class="display" id="basic-1">
                        ...
                        <tbody>
                           <?php 
										$city = $service->query("select * from tbl_cover_images where cover_id=".$_GET['list_image_id']." order by id desc");
										$i=0;
										while($row = $city->fetch_assoc())
										{
											$i = $i + 1;
											$count = $service->query("select * from tbl_cover where id=".$row['cover_id']."")->fetch_assoc();
											$bdata = $service->query("select * from tbl_category where id=".$count['cat_id']."")->fetch_assoc();
											...
											<tr>
												...
												<td class="align-middle">
                                                   <?php echo $bdata['title'];?>
                                                </td>
												
												
												
                                                <td class="align-middle">
                                                   <img src="<?php echo $row['text']; ?>" width="100" height="100"/>
                                                </td>
										   ...
										   <a href="?edit_cover_id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;">
...
<a href="javascript:void(0)" data-id="<?php echo $row['id'];?>" class="tabledit-delete-button del" data-type="cvimg_delete" style="float: none; margin: 5px;">
<svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="30" height="30" rx="15" fill="#FFC0AC"/><path d="M23.75 9C23.75 9.414 23.414 9.75 23 9.75H7C6.586 9.75 6.25 9.414 6.25 9C6.25 8.586 6.586 8.25 7 8.25H11.214C11.307 8.068 11.379 7.862 11.456 7.632L11.658 7.02499C11.862 6.41299 12.435 6 13.081 6H16.919C17.565 6 18.138 6.41299 18.342 7.02499L18.544 7.632C18.621 7.862 18.693 8.068 18.786 8.25H23C23.414 8.25 23.75 8.586 23.75 9ZM21.56 10.75C21.733 10.75 21.871 10.897 21.859 11.07L21.19 21.2C21.08 22.78 20.25 24 18.19 24H11.81C9.75 24 8.92 22.78 8.81 21.2L8.141 11.07C8.13 10.897 8.267 10.75 8.44 10.75H21.56ZM13.75 14C13.75 13.59 13.41 13.25 13 13.25C12.59 13.25 12.25 13.59 12.25 14V19C12.25 19.41 12.59 19.75 13 19.75C13.41 19.75 13.75 19.41 13.75 19V14ZM17.75 14C17.75 13.59 17.41 13.25 17 13.25C16.59 13.25 16.25 13.59 16.25 14V19C16.25 19.41 16.59 19.75 17 19.75C17.41 19.75 17.75 19.41 17.75 19V14Z" fill="#25314C"/></svg></a>				
				...
				else if(isset($_GET['edit_cover_id']))
				{
					$data = $service->query("select * from tbl_cover_images where id=".$_GET['edit_cover_id']."")->fetch_assoc();
					?>
					...
					<form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group mb-3">
											...
											<br>
											<img src="<?php echo $data['text']?>" width="100px"/>
											<input type="hidden" name="type" value="edit_cover_img"/>
											
										<input type="hidden" name="id" value="<?php echo $_GET['edit_cover_id'];?>"/>
                                        </div>
                                    ...
                                    <div class="card-footer text-left">
                                        <button  class="btn btn-primary">Edit  Cover Image</button>
                                    </div>
                                </form>
								
					<?php 
				}
				else if(isset($_GET['add_image_id']))
				{
					...
					<form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group mb-3">
											...
											<input type="hidden" name="type" value="add_cover_img"/>
											
										<input type="hidden" name="id" value="<?php echo $_GET['add_image_id'];?>"/>
                                        </div>
                                    ...
                                    <div class="card-footer text-left">
                                        <button  class="btn btn-primary">Add  Cover Image</button>
                                    </div>
                                </form>
                ...
                <table class="display" id="basic-1">
                        ...
                        <tbody>
                           <?php 
										$city = $service->query("select * from tbl_cover where vendor_id=".$sdata['id']." order by id desc");
										$i=0;
										while($row = $city->fetch_assoc())
										{
											$i = $i + 1;
											$bdata = $service->query("select * from tbl_category where id=".$row['cat_id']."")->fetch_assoc();
											$count = $service->query("select * from tbl_cover_images where cover_id=".$row['id']."")->num_rows;
											?>
											<tr>
                                                <td>
                                                    <?php echo $i; ?>
                                                ...
                                                <td class="align-middle">
                                                   <a href="?add_image_id=<?php echo $row['id'];?>"><button class="btn btn-info">Add Images</button></a>
                                                </td>
												
												 <td class="align-middle">
                                                  <a href="?list_image_id=<?php echo $row['id'];?>"> <button class="btn btn-success">List Images</button> </a>
                                                </td>
                                                ...
                                                <td style="white-space: nowrap; width: 15%;"><div class="tabledit-toolbar btn-toolbar" style="text-align: left;">
                                           <div class="btn-group btn-group-sm" style="float: none;">
										   <a href="add_Cover.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;">
<svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="30" height="30" rx="15" fill="#79F9B4"/><path d="M22.5168 9.34109L20.6589 7.48324C20.0011 6.83703 18.951 6.837 18.2933 7.49476L16.7355 9.06416L20.9359 13.2645L22.5052 11.7067C23.163 11.0489 23.163 9.99885 22.5168 9.34109ZM15.5123 10.2873L8 17.8342V22H12.1658L19.7127 14.4877L15.5123 10.2873Z" fill="#25314C"/></svg></a>
