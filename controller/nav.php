          ...
          <div class="nav-right col-10 col-sm-6 pull-right right-header p-0">
            <ul class="nav-menus">
			  ...
			  ?>
				...
				{
				?>
                  <svg class="lighticon drop" width="24" height="24" viewBox="0 0 24 24" data-id="1" data-status="1"  data-type="update_status" coll-type="dark_mode" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g>
                      <g>                 
				...
				<?php } else { ?>
                  ...
                  <svg class="darkicon drop" width="24" height="24" viewBox="0 0 24 24" fill="none"  data-id="1" data-status="0"  data-type="update_status" coll-type="dark_mode" xmlns="http://www.w3.org/2000/svg">
