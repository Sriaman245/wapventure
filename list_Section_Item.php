            ...
            <div class="page-title">
              <div class="row">
                <div class="col-12 col-sm-6">
                  <h3>Home Section Item List Management</h3>
                </div>
             ...
             <div class="col-sm-12">
                ...
                <table class="display" id="basic-1">
                        <thead>
                          <tr>
											<th>Sr No.</th>
											<th>Section Item Title</th>
											<th>Home Section Title</th>
											<th>Section Item Image</th>
												<th>Section Item Status</th>
												<th>Action</th>
									</tr>
                                        </thead>
                                        <tbody>
                                           <?php 
										$city = $service->query("select * from section_item");
										$i=0;
										while($row = $city->fetch_assoc())
										{
											$cdata = $service->query("select * from tbl_section where id=".$row['section_id']."")->fetch_assoc();
											$i = $i + 1;
											?>
											<tr>
                                                <td>
										   ...
										   <a href="add_Section_Item.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;">
<svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="30" height="30" rx="15" fill="#79F9B4"/><path d="M22.5168 9.34109L20.6589 7.48324C20.0011 6.83703 18.951 6.837 18.2933 7.49476L16.7355 9.06416L20.9359 13.2645L22.5052 11.7067C23.163 11.0489 23.163 9.99885 22.5168 9.34109ZM15.5123 10.2873L8 17.8342V22H12.1658L19.7127 14.4877L15.5123 10.2873Z" fill="#25314C"/></svg></a>
										   <a href="javascript:void(0)" data-id="<?php echo $row['id'];?>" class="tabledit-delete-button  del" data-type="home_item_delete" style="float: none; margin: 5px;">
