            ...
            <div class="row">
             ...
             <div class="col-sm-12">
                ...
                <table class="display" id="basic-1">
                        ...
                        <tbody>
                           <?php 
										$city = $service->query("select * from tbl_partner where vendor_id=".$sdata['id']." order by id desc");
										$i=0;
										while($row = $city->fetch_assoc())
										{
										   ...
										   <a href="add_Partner.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;">
