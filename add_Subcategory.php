            ...
            <div class="row">
             ...
             <div class="col-sm-12">
                <div class="card">
				 ...
				 if(isset($_GET['id']))
				 {
					 $data = $service->query("select * from tbl_subcategory where id=".$_GET['id']."")->fetch_assoc();
					 ?>
...
?>
                                        ...
                                        <div class="form-group mb-3">
											...
											<input type="hidden" name="type" value="edit_subcategory"/>
                                    ...
                                    <div class="card-footer text-left">
                                        <button  class="btn btn-primary">Edit  Subcategory</button>
                                    </div>
                                </form>
					 <?php 
				 }
...
?>
                                        ...
                                        <div class="form-group mb-3">
											...
											<input type="hidden" name="type" value="add_subcategory"/>
                                        </div>
