                    ...
                    <div class="default-according-page default-according" id="accordionclose">
                      <div class="card">
                        <div class="card-header pb-0" id="headingFour">
                          <h5 class="mb-0">
                            <button class="btn btn-link text-white bg-primary" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="true" aria-controls="collapseFour">Instruction <span>(Click Here)</span></button>
                          </h5>
                        </div>
...
<path style=" stroke:none;fill-rule:nonzero;fill:rgb(4.313725%,64.313725%,87.843137%);fill-opacity:1;" d="M 14.625 14.675781 C 14.625 15.53125 13.933594 16.222656 13.078125 16.222656 C 12.222656 16.222656 11.53125 15.53125 11.53125 14.675781 C 11.53125 13.824219 12.222656 13.128906 13.078125 13.128906 C 13.933594 13.128906 14.625 13.824219 14.625 14.675781 Z M 14.625 14.675781 "/>
 ...
 Click this icon to start pin points in the map and connect them to draw a zone . Minimum 3 points required</p>
				 ...
				 if(isset($_GET['id']))
				 {
					 $data = $service->query("select * from zones where id=".$_GET['id']."")->fetch_assoc();
					 ?>
					  <div class="card-body">
   ...
   <?php include 'controller/service.php';?>
    ...
    <!-- Plugin used-->
	 ...
	 <?php      if(!isset($_GET['id']))
				{
					?>
		<script src="https://maps.googleapis.com/maps/api/js?key=Map_Key_Here&libraries=drawing,places&v=3.45.8"></script> 			
		<script>
...
function auto_grow() {
        ...
        google.maps.event.addDomListener(window, 'load', initialize);
				...
				<?php } else { ?>
		<script src="https://maps.googleapis.com/maps/api/js?v=3.45.8&key=Map_Key_Here&libraries=drawing,places"></script>
	<script>
    auto_grow();
    function auto_grow() {
        let element = document.getElementById("coordinates");
