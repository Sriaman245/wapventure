<?php
require dirname(dirname(dirname( dirname(__FILE__) ))).'/controller/serviceconfig.php';
$kb = $service->query("SELECT * FROM `tbl_payment_list` where id=6")->fetch_assoc();
...
if (PAYTM_ENVIRONMENT == 'PROD') {
	...
	$PAYTM_CALLBACK_URL 	= "https://mrurban.zozostudio.tech/paytm/response.php";
